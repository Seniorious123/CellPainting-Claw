...
def nanobot_task_routes() -> list[NanoBotTaskRoute]:
    ...
    return [
        ...
        NanoBotTaskRoute(
            ...
            preferred_target='plan-data-access',
            reason='This modular skill handles data planning directly and stays separate from processing steps.',
            params_template={
        ...
        NanoBotTaskRoute(
            ...
            user_goal='Run segmentation and produce masks, previews, and single-cell crops.',
            preferred_tool='run_pipeline_skill',
            preferred_target='run-segmentation',
            reason='Segmentation is a standalone modular skill and should not be hidden behind a combined workflow alias.',
            params_template={
                'skill_key': 'run-segmentation',
                'config_path': config_path,
                'params_json': '{}',
            },
        ),
        NanoBotTaskRoute(
            ...
            user_goal='Run the DeepProfiler branch from the standardized pipeline interface.',
            preferred_tool='run_pipeline_skill',
            preferred_target='run-deepprofiler',
            reason='The modular DeepProfiler skill captures the intended branch without exposing internal workflow names.',
            params_template={
