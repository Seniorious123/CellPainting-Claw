...
MCP_TOOLS: dict[str, McpToolDefinition] = {
    ...
    'list_pipeline_skills': McpToolDefinition(
        ...
        target_name=None,
        requires_config=False,
        description='List the task-oriented pipeline skills that sit above presets.',
        recommended_for='Agent discovery of higher-level task names such as run-full-workflow or run-deepprofiler-full.',
        input_schema={'type': 'object', 'properties': {}},
    ...
    'run_pipeline_skill': McpToolDefinition(
        ...
        description='Run one named task-oriented skill.',
    ...
    'list_pipeline_presets': McpToolDefinition(
        ...
        target_name=None,
        requires_config=False,
        description='List the named orchestration presets that bundle common parameter combinations.',
        recommended_for='Agent discovery of reusable workflow shapes before applying task-level skill names.',
        input_schema={'type': 'object', 'properties': {}},
    ...
    'run_pipeline_preset': McpToolDefinition(
        ...
        requires_config=True,
        description='Run one named orchestration preset.',
        recommended_for='Agent execution when the workflow shape is known but the task does not need a higher-level skill alias.',
        input_schema={
            'type': 'object',
            'required': ['preset_key'],
            'properties': {
